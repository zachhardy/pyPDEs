...
class UnknownManager:
    ...
    There are two types of storage methods: NODAL and
    BLOCK. NODAL storage orders the dofs according to unknown,
    component, and then node, whereas BLOCK storage orders
    the dofs according to node, unknown, and then component.
    """
